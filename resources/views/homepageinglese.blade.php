            ...
            <div class="dropdown">
              ...
              <ul class="dropdown-menu" style="margin-left: 100px">
                <li><a class="dropdown-item" href="#"> <form action="/logout" method="post">
                  ...
                  <button class="logout" type="submit">YOU GO OUT</button></a></li>
                      ...
                      <div class="flip-card">
                          <div class="flip-card-inner">
                              ...
                              <div class="flip-card-back">
                                  ...
                                  <p>It has an excellent 6.7 inch display with a resolution of 1290 x 2796 pixels with LTPO Super Retina XDR OLED technology, 120Hz, HDR10, Dolby Vision, 1000 nits (typ), 2000 nits (HBM). On the hardware side, the iPhone 15 Pro Max features an Apple A17 Pro (3nm) SOC and has GB of RAM.</p>
                              </div>
                          </div>
                      </div>
               ...
               <!--<div class="cards-wrapper">-->
                    <!--<div class="card-container">-->
                      <div class="flip-card">
                          <div class="flip-card-inner">
                              <div class="flip-card-front">
                                  <img class="imgGirevole" src="https://images.samsung.com/is/image/samsung/p6pim/uk/2302/gallery/uk-galaxy-s23-s918-447009-sm-s918bzrheub-534887130?$650_519_PNG$" alt="IPHONE 15 PRO MAX ">
                                  <h3>SAMSUNG GALAXY S24</h3>
                                  <button class="btn description-btn">Description</button>
                              </div>
                              <div class="flip-card-back">
                                  <p class="title">Description</p>
                                  <p>The Galaxy S24 series' AI tools – many powered by Google – summarize notes and web pages and make writing suggestions. Generative AI also modifies images taken with the smartphone in surprising ways</p>
                              </div>
                          </div>
                      </div>
                ...
                <!--<div class="cards-wrapper">-->
                    <!--<div class="card-container">-->
                      <div class="flip-card">
                          <div class="flip-card-inner">
                              <div class="flip-card-front">
                                  <img class="imgGirevole" src="https://www.html.it/app/uploads/2023/03/PlayStation-5-Standard-Edition.png" alt="PLAYSTATION 5 ">
                                  <h3>PLAYSTATION 5</h3>
                                  <button class="btn description-btn">Description</button>
                              </div>
                              <div class="flip-card-back">
                                  <p class="title">Description</p>
                                  <p>The PlayStation 5 uses AMD's Zen 2 processor with 8 cores at a variable frequency limited to 3.5 GHz. The GPU is a custom system-on-chip (SoC), based on AMD's RDNA 2, with 36 compute units running at variable frequency, limited to 2.23 GHz and capable of 10.28 TFLOPS.</p>
                              </div>
                          </div>
                      </div>
               ...
               <!--<div class="cards-wrapper">-->
                    <!--<div class="card-container">-->
                      <div class="flip-card">
                          <div class="flip-card-inner">
                              <div class="flip-card-front">
                                  <img class="imgGirevole" src="https://m.media-amazon.com/images/I/713dZHEY2YL._AC_UF894,1000_QL80_.jpg" alt="IPHONE 15 PRO MAX ">
                                  <h3>MSI KATANA 15</h3>
                                  <button class="btn description-btn">Description</button>
                              </div>
                              <div class="flip-card-back">
                                  <p class="title">Description</p>
                                  <p>MSI Notebook - Intel Core i7-12650H - RAM 16GB DDR5 - SSD 1TB - LCD 15.6" FHD (1920*1080), 144Hz 45%NTSC IPS-Level - GPU NVidia RTX4070 8GB DDR6 - Optical drive: no - Intel Wi- Fi 6 AX201(2*2 ax) + BT5.2 - Dimension: 359 x 259 x 24.9 mm - Weight: 2.25 - Windows 11.</p>
                              </div>
                          </div>
                      </div>
            </div>
                            ...
                            <div class="row g-0">
                              ...
                              <div class="col-md-8">
                                <div class="card-body">
                                  ...
                                  <p class="card-text">The Moon in the sixth field asks you to do something simple to make your day better. In the workplace, Mercury in your Sign leaves you with the awareness of having left a positive impact, contributing to the success of your team's activities and feeling appreciated for your commitment. In the field ... </p>
                            ...
                            <div class="row g-0">
                              ...
                              <div class="col-md-8">
                                <div class="card-body">
                                  ...
                                  <p class="card-text">Guterres in Rafah: ceasefire. Israel: the UN is anti-Semitic with him
                                    UN, a text on Gaza will be voted on Monday. Hamas: 32,142 Palestinians dead. Three Houthi storage warehouses hit in Yemen </p>
                            ...
                            <div class="row g-0">
                              ...
                              <div class="col-md-8">
                                <div class="card-body">
                                  ...
                                  <p class="card-text">ATP Miami, Sinner beats Vavassori 6-3, 6-4 and reaches the third round
                                    The Italian derby was suspended yesterday at 3-2 40-40 in the first set due to rain and postponed to today  </p>
                                  <!--PULSANTE DI INVIO LINK-->
                            ...
                            <div class="row g-0">
                              ...
                              <div class="col-md-8">
                                <div class="card-body">
                                  ...
                                  <p class="card-text">Bari, Decaro on Sky TG24: "No shadows on the council. Let's not lower our heads"
                                    Politics
                                   
                                    From Rome, where he participated in Libera's march, the mayor returns to the decision of ...</p>
                              ...
                              <div class="col-md-8">
                                <div class="card-body">
                                  ...
                                  <p class="card-text">USA, child born deaf can hear again thanks to gene therapy
                                    ...
                                    This is a successful experimental treatment, conducted at the Children's Hospital... </p>
                                  <!--PULSANTE DI INVIO LINK-->
                      ...
                      <div class="row g-0">
                        ...
                        <div class="col-md-8">
                          <div class="card-body">
                            ...
                            <p class="card-text">Brazil, first transgenic cow that produces human insulin in milk
                              Science
                             
                              It could pave the way for an alternative production method to the current ones based...
                    ...
                    <div class="row g-0">
                      ...
                      <div class="col-md-8">
                        <div class="card-body">
                          ...
                          <p class="card-text">Fashion, star style: 21 details and trends from the Oscars red carpet
                            Show
                           
                            The Oscars red carpet is a huge catwalk to keep an eye on to study the trends...</p>
                          <!--PULSANTE DI INVIO LINK-->
                  ...
                  <div class="row g-0">
                    ...
                    <div class="col-md-8">
                      <div class="card-body">
                        ...
                        <p class="card-text">Controls on influencers, the Financial Police recover 11 million
                          News
                         
                          The investigations conducted on four influencers from Bologna, followed by 50 million followers, and... </p>
                        <!--PULSANTE DI INVIO LINK-->
                ...
                <div class="card-container">
                    ...
                    <div class="flip-card">
                        <div class="flip-card-inner">
                            ...
                            <div class="flip-card-back">
                                <p class="title">Description</p>
                                <p>Who we are. Aulab is the first Italian Coding Factory active since 2014 in the field of
                                  training and software development. With our courses we train resources in the IT field
                ...
                <div class="card-container">
                    ...
                    <div class="flip-card">
                        <div class="flip-card-inner">
                            ...
                            <div class="flip-card-back">
                                <p class="title">Description</p>
                                <p>Laravel is a PHP framework, obviously oriented towards object-oriented programming and
