                ...
                <div class="col-12 col-md-10 col-lg-5 ms-auto">
                    <div class="p-5 bg-light rounded text-center">
                        <form action="/login" method="post">
                            ...
                            <h1 class="text-muted">ACCEDI</h1>

                            <h3 class="fw-bold mb-5">Alla community di Aulab post</h3>

                            @csrf

                            <input class="form-control mb-2" type="text" id="email" name="email" required
                            ...
                            <button class="btn btn-primary py-2 w-100 mb-4">ACCEDI</button>
                            <a class="link-secondary d-inline-block mb-4" href="#"><small>Password
                                    dimenticata</small></a>

                            <a class="d-flex justify-content-center align-items-center text-muted mb-2 py-2 bg-white rounded w-100 text-decoration-none"
                                href="#">
                                <img class="img-fluid" src="bootstrap5-plain-assets/socials/facebook.svg"
                                    alt="">
                                <span class="text-muted">Accedi con Facebook</span>
                            </a>

                            <a class="d-flex justify-content-center align-items-center text-muted mb-2 py-2 bg-white rounded w-100 text-decoration-none"
                                href="#">
                                <img class="img-fluid" src="bootstrap5-plain-assets/socials/twitter.svg" alt="">
                                <span class="text-muted">Accedi con Google</span>
                            </a>
