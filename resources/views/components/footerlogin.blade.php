                    ...
                    <div class="flip-card">
                        <div class="flip-card-inner">
                            ...
                            <div class="flip-card-back">
                                ...
                                <p>Chi siamo. Aulab è la prima Coding Factory Italiana attiva dal 2014 nell' ambito della
                                    formazione e dello sviluppo software. Con i nostri corsi formiamo risorse nell'ambito IT
                                    da collocare in aziende alla ricerca di personale.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-container">
                    ...
                    <div class="flip-card">
                        <div class="flip-card-inner">
                            ...
                            <div class="flip-card-back">
                                <p class="title">DESCRIZIONE</p>
                                <p>Laravel è un framework PHP, ovviamente orientato alla programmazione ad oggetti ed al
                                    pattern architetturale MVC (che se non conoscete consiglio caldamente di studiarvi) e
                                    all'eliminazione di uno dei nostri peggiori nemici, lo spaghetti code.</p>
                            </div>
                        </div>
                    </div>
